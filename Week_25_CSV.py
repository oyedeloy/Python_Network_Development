from inventory_1 import csv_inventory
import csv
...
with open("inventory.csv", "w") as csv_out:
...
with open("manheim.csv", "r") as csv_in:
    csv_reader = csv.reader(csv_in)
